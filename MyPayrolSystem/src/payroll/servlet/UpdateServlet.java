	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
	     ...
	     //   int Id = Integer.parseInt(request.getParameter("sid"));
			...
			session.setAttribute("emp_code", Id);
			...
			try {
				...
				List<EmpListVO> empUpdateLists = ObjDAO.updateList(Id,EmpName,Presentadd,City, Pincode, Permanantaddrss, Phnum, Mobnum,  Bloodgroup, Nationality ,Languageknown ,pancardNum, Emptype, Empgrade, Empcode, Empsignature);
