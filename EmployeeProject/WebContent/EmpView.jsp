	...
	<th>delete</th>
			...
			<c:forEach var = "emp" items="${sessionScope.emplShowAttribute}">
				<tr>
					...
					<td><a href="UpdateEmpServlet?editid=${emp.empId}"><font size="3" color="red">Edit</font></a></td>
					<td><a href="DeleteServlet?deleteid=${emp.empId}"><font size="3" color="red">Delete</font></a></td>
